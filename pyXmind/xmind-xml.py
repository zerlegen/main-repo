...
def open_xmind_map(outFile, theme):
...
open_xmind_map(outFile, "brainy.defaultGenre.simple")
...
write_XMIND_TOPIC_OPEN(outFile, "org.xmind.ui.map.clockwise", 
		       generate_xmind_timestamp())
